...
export class InvoiceForm extends Component {
    ...
    setup() {
        ...
        this.state = useState({
            ...
            invoiceId: isEditMode ? editData.invoiceId : '',
            ...
            invoiceType: isEditMode ? editData.invoiceType : '',
    ...
    submitInvoice() {
        if (this.validateForm()) {
            console.log('Submitting invoice...', this.collectFormData());
            this.showNotification('Invoice submitted successfully', 'success');
            this.goBack();
        }
    }
