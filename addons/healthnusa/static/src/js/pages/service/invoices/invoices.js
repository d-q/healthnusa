...
export class Invoices extends Component {
    static template = "healthnusa.Invoices";
    static props = {
    ...
    setup() {
        ...
        this.state.filteredItems = this.invoicesData;
    }

    addNewInvoice() {
        this.props.selectApp('invoice-new');
    }
            ...
            filtered = filtered.filter(invoice => {
                if (this.state.currentSearchField === 'all') {
                    return (
                        ...
                        invoice.patient_id.toLowerCase().includes(searchTerm) ||
                        invoice.status.toLowerCase().includes(searchTerm) ||
                        invoice.category.toLowerCase().includes(searchTerm) ||
                        invoice.amount.toString().includes(searchTerm)
                    );
                } else {
                    return invoice[this.state.currentSearchField].toString().toLowerCase().includes(searchTerm);
                }
            });
        }
    ...
    viewInvoice(invoiceId) {
        this.props.selectApp('invoice-detail');
    }
